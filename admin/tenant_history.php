...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'delete') {
    $id = intval($_POST['id']);
    $conn->query("DELETE FROM tenant_history WHERE id = $id");
...
if (!empty($_GET['room'])) {
    ...
    $where .= " AND room_number LIKE '%$room%'";
}

$history = $conn->query("SELECT * FROM tenant_history WHERE $where ORDER BY end_date DESC, created_at DESC");
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <title>历史租户 - <?php echo $siteName; ?></title>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" placeholder="搜索租客姓名、电话或房间号..." value="<?php echo $_GET['search'] ?? ''; ?>">
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="room" class="form-control" placeholder="房间号..." value="<?php echo $_GET['room'] ?? ''; ?>">
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><i class="bi bi-door-open"></i> <?php echo $h['room_number']; ?></h5>
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2"><i class="bi bi-person text-muted me-2"></i><strong>租客：</strong><?php echo $h['tenant_name']; ?></li>
                                    <li class="mb-2"><i class="bi bi-telephone text-muted me-2"></i><strong>电话：</strong><?php echo $h['tenant_phone']; ?></li>
                                    <li class="mb-2"><i class="bi bi-gender-ambiguous text-muted me-2"></i><strong>性别：</strong><?php echo $h['tenant_gender'] ?: '-'; ?></li>
                                    <li class="mb-2"><i class="bi bi-credit-card text-muted me-2"></i><strong>身份证：</strong><?php echo $h['tenant_idcard'] ?: '-'; ?></li>
                                    <li class="mb-2"><i class="bi bi-building text-muted me-2"></i><strong>公司：</strong><?php echo $h['tenant_company'] ?: '-'; ?></li>

...
// 获取历史账单详情
$bill = $conn->query("SELECT * FROM bill_history WHERE id = $bill_id")->fetch_assoc();
...
<head>
    ...
    <title>历史账单详情 - <?php echo $siteName; ?></title>
...
<body>
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <a href="bill_history.php" class="btn btn-outline-dark btn-sm"><i class="bi bi-arrow-left me-1"></i> 返回</a>
        </div>
    </nav>
    ...
    <div class="bill-paper" id="billContent">
        <div class="bill-header">
            ...
            <div class="bill-subtitle">水电房租账单（历史记录）</div>
        </div>

        <table style="width:100%; margin-bottom:20px;">
            <tr><td style="width:100px; color:#86868b;">账单月份：</td><td><strong><?php echo $bill['bill_month']; ?></strong></td></tr>
            <tr><td style="color:#86868b;">房间号：</td><td><strong><?php echo $bill['room_number']; ?></strong></td></tr>
            ...
            <tr><td style="color:#86868b;">归档时间：</td><td><?php echo date('Y-m-d H:i', strtotime($bill['archived_at'])); ?></td></tr>
        </table>
        ...
        <div style="margin-top: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
            <small class="text-muted"><i class="bi bi-info-circle me-1"></i> 此为历史账单记录，归档时间：<?php echo date('Y-m-d H:i', strtotime($bill['archived_at'])); ?></small>
        </div>
    </div>
</body>
</html>

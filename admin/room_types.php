...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($postAction == 'add') {
        ...
        $sql = "INSERT INTO room_types (name, description, price, area) 
                VALUES ('$name', '$description', $price, $area)";
...
$types = $conn->query("SELECT * FROM room_types WHERE $where ORDER BY price");

$editType = null;
if ($action == 'edit' && $id) {
    $result = $conn->query("SELECT * FROM room_types WHERE id = $id");
    $editType = $result->fetch_assoc();
}
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <title>房间类型管理 - <?php echo $siteName; ?></title>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            <div class="col-md-6">
                                <input type="text" name="search" class="form-control" placeholder="搜索类型名称..." value="<?php echo $_GET['search'] ?? ''; ?>">
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-header bg-dark text-white">
                                <h5 class="mb-0"><i class="bi bi-tag"></i> <?php echo $type['name']; ?></h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted"><?php echo $type['description'] ?: '暂无描述'; ?></p>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" required
                                           value="<?php echo $action == 'edit' ? $editType['name'] : ''; ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="3"><?php echo $action == 'edit' ? $editType['description'] : ''; ?></textarea>
                            </div>

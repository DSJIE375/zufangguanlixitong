...
$siteName = getSetting('site_name') ?: '出租房';
...
<head>
    ...
    <title>账单 - <?php echo $bill['room_number']; ?> - <?php echo $siteName; ?></title>
    ...
    <style>
        ...
        @media print { body { background: white; } .bill-paper { box-shadow: none; margin: 0; padding: 20px; } .no-print { display: none !important; } }
    </style>
</head>
<body>
    <!-- 操作按钮 -->
